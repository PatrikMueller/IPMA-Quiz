...
type AppState = 'loading' | 'mode-selection' | 'language-selection' | 'category-selection' | 'quiz-active' | 'results';
...
function QuizApp() {
  ...
  const handleLanguageSelect = (language: string, quizSets: any[]) => {
    setSelectedLanguage(language);
    // Auto-sync: Set UI language to match quiz language
      ...
      <header className="bg-white dark:bg-gray-800 shadow-sm border-b border-gray-200 dark:border-gray-700 flex-shrink-0">
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            {appState !== 'loading' && appState !== 'language-selection' && (
              <button
                ...
                return (
                  <div className="container mx-auto px-6">
                    <LanguageSelector
                      ...
                      onLanguageSelect={(language) => handleLanguageSelect(language, quizSets)}
                    />
                  </div>
                );
